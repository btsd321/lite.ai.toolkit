...
file(GLOB TENSORRT_GPU_SRCS_CPP ${CMAKE_SOURCE_DIR}/lite/trt/gpu/*.cpp)
file(GLOB TENSORRT_GPU_SRCS_CU ${CMAKE_SOURCE_DIR}/lite/trt/gpu/*.cu)
...
file(GLOB TENSORRT_GPU_HEAD_H ${CMAKE_SOURCE_DIR}/lite/trt/gpu/*.h)
file(GLOB TENSORRT_GPU_HEAD_CUH ${CMAKE_SOURCE_DIR}/lite/trt/gpu/*.cuh)
...
set(TRT_SRCS ${TENSORRT_CV_SRCS} ${TENSORRT_NLP_SRCS} ${TENSORRT_ASR_SRCS} ${TENSORRT_CORE_SRCS} ${TENSORRT_SD_SRCS}
        ...
        ${TENSORRT_GPU_SRCS_CPP} ${TENSORRT_GPU_SRCS_CU})
set_source_files_properties(${TENSORRT_CUDA_KERNEL_SRCS_CU} ${TENSORRT_CUDA_KERNEL_SRCS_CPP}
        ...
        ${TENSORRT_GPU_SRCS_CU} ${TENSORRT_GPU_SRCS_CPP}
        ${TENSORRT_GPU_HEAD_CUH} ${TENSORRT_GPU_HEAD_H}
...
set(TRT_HEADERS ${TENSORRT_CORE_HEAD} ${TENSORRT_CV_HEAD} ${TENSORRT_ASR_HEAD} ${TENSORRT_NLP_HEAD} ${TENSORRT_SD_HEAD} ${TENSORRT_CUDA_KERNEL_HEAD_CPP} ${TENSORRT_CUDA_KERNEL_HEAD_CU} ${TENSORRT_GPU_HEAD_H} ${TENSORRT_GPU_HEAD_CUH})
