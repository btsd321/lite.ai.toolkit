...
public:
    ...
    explicit TRTYOLO12(const std::string &_trt_model_path, unsigned int _num_threads = 1);
    explicit TRTYOLO12(const std::string &_trt_model_path, ImageFormat _input_format,
