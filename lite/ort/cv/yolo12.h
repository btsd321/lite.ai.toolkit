...
#ifndef LITE_AI_ORT_CV_YOLO12_H
#define LITE_AI_ORT_CV_YOLO12_H

#include "lite/ort/core/ort_core.h"

namespace ortcv
{
    class LITE_EXPORTS YOLO12 : public BasicOrtHandler
    {
    public:
        explicit YOLO12(const std::string &_onnx_path, unsigned int _num_threads = 1) : BasicOrtHandler(_onnx_path, _num_threads) {};

        ~YOLO12() override = default;
