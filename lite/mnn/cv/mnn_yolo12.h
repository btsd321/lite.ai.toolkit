...
#ifndef LITE_AI_MNN_CV_MNN_YOLO12_H
#define LITE_AI_MNN_CV_MNN_YOLO12_H

#include "lite/mnn/core/mnn_core.h"

namespace mnncv
{
    class LITE_EXPORTS MNNYOLO12 : public BasicMNNHandler
    {
    public:
        explicit MNNYOLO12(const std::string &_mnn_path, unsigned int _num_threads = 1) : BasicMNNHandler(_mnn_path, _num_threads) {};

        ~MNNYOLO12() override = default;
...
#endif // LITE_AI_MNN_CV_MNN_YOLO12_H