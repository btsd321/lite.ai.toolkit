...
#include "lite/mnn/cv/mnn_yolo12.h"
...
#include "lite/ncnn/cv/ncnn_yolo12.h"
...
#include "lite/tnn/cv/tnn_yolo12.h"
    ...
    namespace mnn
    {
        namespace cv
        {
            ...
            namespace detection
            {
                ...
                typedef mnncv::MNNYOLO12 YOLO12;
            }
            // face etc.
            namespace face
            {
    ...
    namespace ncnn
    {
        ...
        namespace cv
        {
            ...
            namespace detection
            {
                ...
                typedef ncnncv::NCNNYOLO12 YOLO12;
            }
            // face etc.
            namespace face
            {
    ...
    namespace tnn
    {
        ...
        namespace cv
        {
            ...
            namespace detection
            {
                ...
                typedef tnncv::TNNYOLO12 YOLO12;
            }
            // face etc.
            namespace face
            {
